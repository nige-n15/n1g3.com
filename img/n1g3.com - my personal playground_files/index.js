...
function setGecko(data){
	...
	$('#btc_mcap').html(btc_mcap.toFixed(2).toLocaleString('en-GB',{ valute: 'GBP'}));
	$('#eth_mcap').html(eth_mcap.toFixed(2));
	$('#xmr_mcap').html(xmr_mcap.toFixed(2));
	$('#bch_mcap').html(ksm_mcap.toFixed(2));
	$('#dot_mcap').html(dot_mcap.toFixed(2));
	$('#ksm_mcap').html(ksm_mcap.toFixed(2));
}